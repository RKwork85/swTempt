...
class VideoTrimmerApp(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowIcon(QtGui.QIcon(r'视频素材剪辑处理\icons\app-icon.png'))
        ...
        self.input_folder_button.setIcon(QtGui.QIcon(r'视频素材剪辑处理\icons\folder-open.png'))
        ...
        self.output_folder_button.setIcon(QtGui.QIcon(r'视频素材剪辑处理\icons\folder-open.png'))
        ...
        self.process_button.setIcon(QtGui.QIcon('icons/play.png'))
        ...
        layout.addSpacing(20)
        layout.addWidget(self.status_label)  # Add the label for the output log
    ...
    def trim_videos(self):
        ...
        for i, filename in enumerate(files):
            ...
            if os.path.isfile(input_path):
                ...
                command = [
                    r'C:\Users\rkwor\Downloads\ffmpeg-7.1-essentials_build\bin\ffmpeg', '-ss', trim_time, '-i', input_path, '-c:v', 'copy', '-c:a', 'aac', '-b:a', '192k', 
